...
c.url.default_page = "https://alphacerium.dev/startpage"
c.url.start_pages = "https://alphacerium.dev/startpage"
...
c.url.searchengines = {
    ...
    "who": "https://farside.link/whoogle/search?q={}&lang_interface=en",
...
c.colors.tabs.selected.odd.bg = "#5d92e8"

# Background color of selected even tabs.
# Type: QtColor
# c.colors.tabs.selected.even.bg = '#282c34'
c.colors.tabs.selected.even.bg = "#5d92e8"
...
config.bind(
    ",mo",
    'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/mocha/mocha-all-sites.css ""',
)
