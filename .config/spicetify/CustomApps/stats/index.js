var stats = (() => {
  ...
  // postcss-module:C:\Users\user\AppData\Local\Temp\tmp-14920-Th2oupbRgCeq\18eb17b3bb53\navBar.module.css
  ...
  var Status = (props) => {
    const [isVisible, setIsVisible] = import_react11.default.useState(false);
    ...
    return isVisible ? /* @__PURE__ */ import_react11.default.createElement(import_react11.default.Fragment, null, /* @__PURE__ */ import_react11.default.createElement("div", {
      className: "loadingWrapper"
    }, props.icon === "error" ? /* @__PURE__ */ import_react11.default.createElement(ErrorIcon, null) : /* @__PURE__ */ import_react11.default.createElement(LibraryIcon, null), /* @__PURE__ */ import_react11.default.createElement("h1", null, props.heading), /* @__PURE__ */ import_react11.default.createElement("h3", null, props.subheading))) : /* @__PURE__ */ import_react11.default.createElement(import_react11.default.Fragment, null);
  };
  ...
  var ArtistsPage = ({ configWrapper }) => {
    const [topArtists, setTopArtists] = import_react16.default.useState(100);
    ...
    const props = {
      title: "Top Artists",
      headerEls: [dropdown, /* @__PURE__ */ import_react16.default.createElement(refresh_button_default, {
        callback: refresh
      }), /* @__PURE__ */ import_react16.default.createElement(settings_button_default, {
        configWrapper
      })]
    };
    switch (topArtists) {
      case 300:
        return /* @__PURE__ */ import_react16.default.createElement(page_container_default, {
          ...props
        }, /* @__PURE__ */ import_react16.default.createElement(status_default, {
          icon: "error",
    ...
    const artistCards = topArtists.map((artist, index) => /* @__PURE__ */ import_react16.default.createElement(spotify_card_default, {
    ...
    return /* @__PURE__ */ import_react16.default.createElement(import_react16.default.Fragment, null, /* @__PURE__ */ import_react16.default.createElement(page_container_default, {
      ...props
    }, /* @__PURE__ */ import_react16.default.createElement("div", {
      className: `main-gridContainer-gridContainer grid`
    }, artistCards)));
  };
  var top_artists_default = import_react16.default.memo(ArtistsPage);
  ...
  var ArtistLink = ({ name, uri, index, length }) => {
    return /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, /* @__PURE__ */ import_react17.default.createElement("a", {
      draggable: "true",
      dir: "auto",
      href: uri,
      tabIndex: -1
  ...
  var ExplicitBadge = import_react17.default.memo(() => {
  ...
  var LikedIcon = ({ active, uri }) => {
    const [liked, setLiked] = import_react17.default.useState(active);
    const toggleLike = () => {
      if (liked) {
    ...
    return /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.TooltipWrapper, {
  ...
  var MenuWrapper = import_react17.default.memo((props) => /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.AlbumMenu, {
    ...props
  }));
  var TrackRow = (props) => {
    const ArtistLinks = props.artists.map((artist, index) => {
      return /* @__PURE__ */ import_react17.default.createElement(ArtistLink, {
        index,
    ...
    return /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.ContextMenu, {
      menu: /* @__PURE__ */ import_react17.default.createElement(MenuWrapper, {
        uri: props.uri
      }),
      trigger: "right-click"
      ...
      "aria-rowindex": 2,
      "aria-selected": "false"
    }, /* @__PURE__ */ import_react17.default.createElement(DraggableComponent, {
      uri: props.uri,
      ...
      "data-encore-id": "type"
    }, props.index), /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.TooltipWrapper, {
      ...
      "data-encore-id": "type"
    }, props.name), props.explicit && /* @__PURE__ */ import_react17.default.createElement(ExplicitBadge, null), /* @__PURE__ */ import_react17.default.createElement("span", {
      ...
      "data-encore-id": "type"
    }, ArtistLinks))), /* @__PURE__ */ import_react17.default.createElement("div", {
      ...
      tabIndex: -1
    }, props.album))), /* @__PURE__ */ import_react17.default.createElement("div", {
      className: "main-trackList-rowSectionEnd",
      role: "gridcell",
      "aria-colindex": 5,
      tabIndex: -1
    }, /* @__PURE__ */ import_react17.default.createElement(LikedIcon, {
      ...
      "data-encore-id": "type"
    }, Spicetify.Player.formatTime(props.duration)), /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.ContextMenu, {
      menu: /* @__PURE__ */ import_react17.default.createElement(MenuWrapper, {
        uri: props.uri
      }),
      trigger: "click"
      ...
      tabIndex: -1
    }, /* @__PURE__ */ import_react17.default.createElement(Spicetify.ReactComponent.TooltipWrapper, {
      label: `More options for ${props.name} by ${props.artists.map((artist) => artist.name).join(", ")}`,
      placement: "top"
    }, /* @__PURE__ */ import_react17.default.createElement("span", null, /* @__PURE__ */ import_react17.default.createElement("svg", {
      role: "img",
      height: "16",
      width: "16",
      "aria-hidden": "true",
  ...
  var track_row_default = import_react17.default.memo(TrackRow);
  ...
  var Tracklist = ({ minified = false, children }) => {
    return /* @__PURE__ */ import_react18.default.createElement("div", {
      ...
      tabIndex: 0
    }, !minified && /* @__PURE__ */ import_react18.default.createElement("div", {
      ...
      "data-encore-id": "type"
    }, "Title"))), /* @__PURE__ */ import_react18.default.createElement("div", {
      className: "main-trackList-rowSectionVariable",
      role: "columnheader",
      "aria-colindex": 3,
      "aria-sort": "none",
      ...
      className: "TypeElement-mesto-type standalone-ellipsis-one-line",
      "data-encore-id": "type"
    }, "Album"))), /* @__PURE__ */ import_react18.default.createElement("div", {
      className: "main-trackList-rowSectionEnd",
      role: "columnheader",
      "aria-colindex": 5,
      "aria-sort": "none",
  ...
  var TracksPage = ({ configWrapper }) => {
    ...
    const [topTracks, setTopTracks] = import_react19.default.useState(100);
    ...
    const props = {
      title: "Top Tracks",
      headerEls: [dropdown, /* @__PURE__ */ import_react19.default.createElement(refresh_button_default, {
        callback: refresh
    ...
    const trackRows = topTracks.map((track, index) => /* @__PURE__ */ import_react19.default.createElement(track_row_default, {
      index: index + 1,
      ...track,
    ...
    return /* @__PURE__ */ import_react19.default.createElement(page_container_default, {
      ...props,
      infoToCreatePlaylist
    }, /* @__PURE__ */ import_react19.default.createElement(tracklist_default, null, trackRows));
  };
  var top_tracks_default = import_react19.default.memo(TracksPage);
  ...
  function StatCard(props) {
    ...
    }, /* @__PURE__ */ import_react20.default.createElement(TextComponent, {
      as: "div",
      semanticColor: "textBase",
      variant: "alto",
  ...
  var genreLine = (name, value, limit, total) => {
    ...
    }, name)), /* @__PURE__ */ import_react21.default.createElement("span", {
  ...
  function InlineGrid(props) {
    ...
    return /* @__PURE__ */ import_react22.default.createElement("section", {
  ...
  var inline_grid_default = import_react22.default.memo(InlineGrid);
  ...
  function Shelf(props) {
    ...
    return /* @__PURE__ */ import_react23.default.createElement("section", {
      ...
      variant: "canon",
      semanticColor: "textBase"
    })))), /* @__PURE__ */ import_react23.default.createElement("section", null, children));
  }
  var shelf_default = import_react23.default.memo(Shelf);
  ...
  var GenresPage = ({ configWrapper }) => {
    const { LocalStorage } = Spicetify;
    const [topGenres, setTopGenres] = import_react24.default.useState(100);
    ...
    const props = {
      title: "Top Genres",
      headerEls: [dropdown, /* @__PURE__ */ import_react24.default.createElement(refresh_button_default, {
        callback: refresh
    ...
    switch (topGenres) {
      case 300:
        return /* @__PURE__ */ import_react24.default.createElement(page_container_default, {
          ...props
        }, /* @__PURE__ */ import_react24.default.createElement(status_default, {
          icon: "error",
          heading: "No API Key or Username",
          subheading: "Please enter these in the settings menu"
        }));
    ...
    const statCards = Object.entries(topGenres.features).map(([key, value]) => {
      return /* @__PURE__ */ import_react24.default.createElement(stat_card_default, {
        label: key,
        value
      });
    });
    const obscureTracks = topGenres.obscureTracks.map((track, index) => /* @__PURE__ */ import_react24.default.createElement(track_row_default, {
      index: index + 1,
      ...track,
    ...
    return /* @__PURE__ */ import_react24.default.createElement(page_container_default, {
      ...
      className: "main-shelf-shelf Shelf"
    }, /* @__PURE__ */ import_react24.default.createElement(genres_card_default, {
      genres: topGenres.genres,
      total: 1275
    }), /* @__PURE__ */ import_react24.default.createElement(inline_grid_default, {
      special: true
    }, statCards)), /* @__PURE__ */ import_react24.default.createElement(shelf_default, {
      title: "Release Year Distribution"
    }, /* @__PURE__ */ import_react24.default.createElement(genres_card_default, {
      genres: topGenres.years,
      total: 50
    })), /* @__PURE__ */ import_react24.default.createElement(shelf_default, {
      title: "Most Obscure Tracks"
    }, /* @__PURE__ */ import_react24.default.createElement(tracklist_default, {
      minified: true
    }, obscureTracks)));
  };
  var top_genres_default = import_react24.default.memo(GenresPage);
  ...
  var LibraryPage = ({ configWrapper }) => {
    const [library, setLibrary] = import_react25.default.useState(100);
    ...
    const artistCards = library.artists.slice(0, 10).map((artist) => {
      return /* @__PURE__ */ import_react25.default.createElement(spotify_card_default, {
        type: "artist",
        uri: artist.uri,
        header: artist.name,
    ...
    }, /* @__PURE__ */ import_react25.default.createElement(stat_card_default, {
    ...
    }, /* @__PURE__ */ import_react25.default.createElement(inline_grid_default, null, artistCards)), /* @__PURE__ */ import_react25.default.createElement(shelf_default, {
      title: "Most Frequent Albums"
    }, /* @__PURE__ */ import_react25.default.createElement(inline_grid_default, null, albumCards)), /* @__PURE__ */ import_react25.default.createElement(shelf_default, {
      title: "Release Year Distribution"
    }, /* @__PURE__ */ import_react25.default.createElement(genres_card_default, {
  ...
  var library_default = import_react25.default.memo(LibraryPage);
  ...
  var ChartsPage = ({ configWrapper }) => {
    const [chartData, setChartData] = import_react26.default.useState(100);
    ...
    if (!chartData[0]?.album) {
      ...
      const trackRows = chartData.map((track, index) => /* @__PURE__ */ import_react26.default.createElement(track_row_default, {
        index: index + 1,
        ...track,
      ...
      return /* @__PURE__ */ import_react26.default.createElement(page_container_default, {
        ...props,
        infoToCreatePlaylist
      }, /* @__PURE__ */ import_react26.default.createElement(tracklist_default, null, trackRows));
    }
  };
  var charts_default = import_react26.default.memo(ChartsPage);
  ...
  var AlbumsPage = ({ configWrapper }) => {
    const { LocalStorage } = Spicetify;
    const [topAlbums, setTopAlbums] = import_react27.default.useState(100);
  ...
  var top_albums_default = import_react27.default.memo(AlbumsPage);
  ...
  var App = () => {
    const [config, setConfig] = import_react28.default.useState({ ...SpicetifyStats.ConfigWrapper.Config });
    const launchModal = () => {
    ...
    const pages = {
      ["Artists"]: /* @__PURE__ */ import_react28.default.createElement(top_artists_default, {
        configWrapper
      }),
      ["Tracks"]: /* @__PURE__ */ import_react28.default.createElement(top_tracks_default, {
        configWrapper
      }),
      ["Albums"]: /* @__PURE__ */ import_react28.default.createElement(top_albums_default, {
        configWrapper
      }),
      ["Genres"]: /* @__PURE__ */ import_react28.default.createElement(top_genres_default, {
        configWrapper
      }),
      ["Library"]: /* @__PURE__ */ import_react28.default.createElement(library_default, {
        configWrapper
      }),
      ["Charts"]: /* @__PURE__ */ import_react28.default.createElement(charts_default, {
        configWrapper
      })
    };
    ...
    const [hasPageSwitched, setHasPageSwitched] = import_react28.default.useState(false);
    ...
    return /* @__PURE__ */ import_react28.default.createElement("div", {
      id: "stats-app"
    }, navBar, newUpdate && /* @__PURE__ */ import_react28.default.createElement("div", {
