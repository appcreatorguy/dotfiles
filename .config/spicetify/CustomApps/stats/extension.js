...
var stats = (() => {
  ...
  function SpotifyCard(props) {
    ...
    const Menu = () => {
      switch (type) {
        case "artist":
          return /* @__PURE__ */ import_react7.default.createElement(ArtistMenu, {
            uri
          });
        case "album":
          return /* @__PURE__ */ import_react7.default.createElement(AlbumMenu, {
            uri,
            artistUri,
            canRemove: true
          });
        case "playlist":
          return /* @__PURE__ */ import_react7.default.createElement(PlaylistMenu, {
            uri
          });
        case "show":
          return /* @__PURE__ */ import_react7.default.createElement(PodcastShowMenu, {
            uri
          });
        case "collection":
          return /* @__PURE__ */ import_react7.default.createElement(collection_menu_default, {
            id: uri
          });
        case "folder":
          return /* @__PURE__ */ import_react7.default.createElement(folder_menu_default, {
            uri
          });
        default:
    ...
    return /* @__PURE__ */ import_react7.default.createElement(ContextMenu, {
      menu: Menu(),
      trigger: "right-click"
    }, /* @__PURE__ */ import_react7.default.createElement(Card, {
      featureIdentifier: type,
      headerText: header,
      renderCardImage: () => /* @__PURE__ */ import_react7.default.createElement(CardImage, {
        images: [
          {
            height: 640,
            url: imageUrl,
      ...
      renderSubHeaderContent: () => /* @__PURE__ */ import_react7.default.createElement(TextComponent, {
        as: "div",
        variant: "mesto",
        semanticColor: "textSubdued",
        children: subheader
  ...
  var Status = (props) => {
    const [isVisible, setIsVisible] = import_react8.default.useState(false);
    ...
    return isVisible ? /* @__PURE__ */ import_react8.default.createElement(import_react8.default.Fragment, null, /* @__PURE__ */ import_react8.default.createElement("div", {
      className: "loadingWrapper"
    }, props.icon === "error" ? /* @__PURE__ */ import_react8.default.createElement(ErrorIcon, null) : /* @__PURE__ */ import_react8.default.createElement(LibraryIcon, null), /* @__PURE__ */ import_react8.default.createElement("h1", null, props.heading), /* @__PURE__ */ import_react8.default.createElement("h3", null, props.subheading))) : /* @__PURE__ */ import_react8.default.createElement(import_react8.default.Fragment, null);
  };
  ...
  var inline_grid_default = import_react9.default.memo(InlineGrid);
  ...
  function Shelf(props) {
    ...
    }, /* @__PURE__ */ import_react10.default.createElement(TextComponent, {
      children: title,
      as: "h2",
      variant: "canon",
      semanticColor: "textBase"
    })))), /* @__PURE__ */ import_react10.default.createElement("section", null, children));
  }
  var shelf_default = import_react10.default.memo(Shelf);
  ...
  var PlaylistPage = ({ uri }) => {
    ...
    const [library, setLibrary] = import_react11.default.useState(100);
    ...
    const statCards = Object.entries(library.audioFeatures).map(([key, value]) => {
      return /* @__PURE__ */ import_react11.default.createElement(stat_card_default, {
        label: key,
        value
      });
    });
    const artistCards = library.artists.map((artist) => {
      return /* @__PURE__ */ import_react11.default.createElement(spotify_card_default, {
        type: "artist",
        uri: artist.uri,
        header: artist.name,
    ...
    }, /* @__PURE__ */ import_react11.default.createElement(stat_card_default, {
      label: "Total Tracks",
    ...
    })), /* @__PURE__ */ import_react11.default.createElement(shelf_default, {
      title: "Most Frequent Genres"
    }, /* @__PURE__ */ import_react11.default.createElement(genres_card_default, {
      genres: library.genres,
      total: library.genresDenominator
    }), /* @__PURE__ */ import_react11.default.createElement(inline_grid_default, {
      special: true
    }, statCards)), /* @__PURE__ */ import_react11.default.createElement(shelf_default, {
  ...
  var playlist_default = import_react11.default.memo(PlaylistPage);
  ...
  var Dropdown = (props) => {
    ...
    }, props.options.map((option, index) => /* @__PURE__ */ import_react12.default.createElement("option", {
      key: index,
      value: option
    }, option))));
  };
  var ToggleInput = (props) => {
    ...
    return /* @__PURE__ */ import_react12.default.createElement(Toggle, {
  ...
  var SliderInput = (props) => {
    ...
    return /* @__PURE__ */ import_react12.default.createElement(Slider, {
  ...
  var ConfigRow = (props) => {
    ...
    }, props.name, props.desc && /* @__PURE__ */ import_react12.default.createElement(Spicetify.ReactComponent.TooltipWrapper, {
      label: /* @__PURE__ */ import_react12.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react12.default.createElement(TooltipIcon, null)))), /* @__PURE__ */ import_react12.default.createElement("div", {
      className: "col action"
    }, props.children));
  };
  var ConfigModal = (props) => {
    const { config, structure, appKey, updateAppConfig } = props;
    const [modalConfig, setModalConfig] = import_react12.default.useState({ ...config });
    const modalRows = structure.map((modalRow, index) => {
      ...
      const element = () => {
        switch (modalRow.type) {
          case "toggle":
            return /* @__PURE__ */ import_react12.default.createElement(ToggleInput, {
              storageKey: key,
              value: currentValue,
              callback: updateItem
            });
          case "text":
            return /* @__PURE__ */ import_react12.default.createElement(TextInput, {
              storageKey: key,
              value: currentValue,
              callback: updateItem
            });
          case "dropdown":
            return /* @__PURE__ */ import_react12.default.createElement(Dropdown, {
              storageKey: key,
              value: currentValue,
          ...
          case "slider":
            return /* @__PURE__ */ import_react12.default.createElement(SliderInput, {
              storageKey: key,
              value: currentValue,
              min: modalRow.min,
              max: modalRow.max,
      ...
      return /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, header && index !== 0 && /* @__PURE__ */ import_react12.default.createElement("br", null), header && /* @__PURE__ */ import_react12.default.createElement("h2", {
        className: "section-header"
      }, modalRow.sectionHeader), /* @__PURE__ */ import_react12.default.createElement(ConfigRow, {
        name: modalRow.name,
        desc: modalRow.desc
      }, element()));
    });
    ...
    constructor(modalStructure, key) {
      ...
      this.launchModal = (callback) => {
        ...
        Spicetify.PopupModal.display({
          ...
          content: /* @__PURE__ */ import_react13.default.createElement(config_modal_default, {
            config: this.Config,
  ...
  (function stats() {
    ...
    const playlistEdit = new Topbar.Button("playlist-stats", "visualizer", () => {
      ...
      PopupModal.display({ title: "Playlist Stats", content: /* @__PURE__ */ import_react14.default.createElement(playlist_default, {
        uri: playlistUri
      }), isLarge: true });
    });
